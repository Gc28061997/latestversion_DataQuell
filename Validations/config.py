...
sql_connection_string = 'mysql://db_validation:database@123@mysqlserver-db.mysql.database.azure.com/data'
# sql_connection_string = 'mysql://root:root@localhost/data_validation'
#print(LICENSE_KEY)
